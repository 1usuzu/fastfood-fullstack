...
import com.example.fastfood.data.model.PhoneRequest; // ✅ Bổ sung import
...
public class ForgotPasswordPhoneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgot_password_phone); // ✅ Đúng file layout
        ...
        btnGetOtp.setOnClickListener(v -> {
            ...
            // ✅ Gửi yêu cầu OTP bằng PhoneRequest
